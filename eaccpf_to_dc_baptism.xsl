...
<xsl:variable name="baptism" select="eac-cpf:cpfDescription/eac-cpf:description/eac-cpf:biogHist/eac-cpf:chronItem/eac-cpf:date"/>
...
<xsl:choose>
 ...
 <dc:date><xsl:value-of select="$baptism"/></dc:date>
